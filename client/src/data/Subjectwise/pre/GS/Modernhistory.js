const modernHistoryPYQData = [
  {
    _id: "pyq_modern_history_2026_01",
    year: 2026,
...
Statement 4 is CORRECT: M.N. Roy's supporters (Royists) and socialist leaders such as Jayaprakash Narayan explicitly chose Congress organizational unity over backing Bose's personal political campaign. JP Narayan's Congress Socialist Party deliberately stayed within the Congress mainstream, leaving Bose without a critical left alliance.
...
Therefore, factors 1, 2, and 4 are correct contributors to the formation of the Forward Bloc.`,
  ...
  },
  {
    ...
    styleTag: "statement_pairing",
    difficulty: "Medium",
    questionText: `Consider the following statements regarding the British policy in Awadh immediately after its annexation in 1856:
...
Which of the statements given above is/are correct?`,
    ...
    correctOption: "B",
    explanation: `Background: Awadh was annexed by the British under the Doctrine of Lapse/misgovernance pretext in February 1856 under Lord Dalhousie. The treatment of taluqdars (powerful landlords/revenue intermediaries) was central to the grievances that fuelled the 1857 uprising.
...
Select the answer using the code given below:`,
    ...
    correctOption: "A",
    explanation: `The assertion states that community-based political alliances (i.e., communal politics) have their roots in the Montagu-Chelmsford Reforms of 1919. Let us evaluate each supporting statement:

Statement 1 SUPPORTS the assertion and is CORRECT: The Montagu-Chelmsford Reforms (Government of India Act, 1919) explicitly retained separate electorates for Muslims (introduced by the Morley-Minto Reforms, 1909) and extended the principle to include Sikhs, Indian Christians, Anglo-Indians, and Europeans. This institutionalisation of voting along communal lines directly embedded community identity into the political system, making community-based alliances not just possible but structurally necessary.

Statement 2 SUPPORTS the assertion and is CORRECT: The British colonial policy of "divide and rule" is well-documented. Separate electorates were a deliberate instrument to prevent a unified Indian national identity from translating into political power. By making religion/community the basis of political representation, the British ensured that political mobilisation remained fragmented along communal lines rather than nationalist lines.

Statement 3 does NOT support the assertion and is INCORRECT as a supporting argument: While it is historically true that some depressed/minority communities sought benefits from separate representation (e.g., the debate around the Communal Award of 1932 and the Poona Pact), this statement describes a consequence/effect of separate electorates rather than something that supports the original assertion about the reforms being the genesis of community-based alliances. Deprived classes rallying around these provisions is a downstream behaviour, not a causal explanation for why the reforms created communal politics.
...
Therefore, only statements 1 and 2 support the assertion.`,
  ...
  {
    _id: "pyq_modern_history_2026_04",
    year: 2026,
    subject: "Modern History",
    ...
    options: [
      {
        id: "A",
        text: "To stabilise the Indian economy after the severe disruptions caused by the First World War",
      },
      {
        id: "B",
        text: "To benefit British manufacturers and exporters by making their goods cheaper in India",
      },
      {
        id: "C",
        text: "To enable the British Government to maximise its Home Charges remittances to England",
      },
      {
        id: "D",
        text: "To facilitate the repayment of India's sterling debt on favourable terms for Britain",
      },
    ],
    correctOption: "C",
...
Options B and D are secondary effects or partial truths but not the primary stated rationale.`,
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "Both the Eka Movement and the Bardoli Satyagraha were led by the Indian National Congress against enhanced land revenue demands.",
      },
      {
        id: "B",
        text: "The Eka Movement was in United Provinces and the Bardoli Satyagraha was in Gujarat; both were peasant movements against unjust revenue enhancements.",
      },
      {
        id: "C",
        text: "The Eka Movement was a success whereas the Bardoli Satyagraha ended in failure for the peasants.",
      },
      {
        id: "D",
        text: "Both movements took place in Gujarat and were organised by Sardar Vallabhbhai Patel.",
      },
    ],
    correctOption: "B",
    explanation: `The Eka Movement (1921–22) and the Bardoli Satyagraha (1928) are both landmark peasant movements of colonial India, but they differ significantly in leadership, geography, and outcome.

The Eka Movement:
— Location: Hardoi, Bahraich, and Sitapur districts of United Provinces (present-day Uttar Pradesh).
— Period: 1921–22, during the Non-Cooperation Movement era.
— Leadership: Led by Madari Pasi (a lower-caste grassroots leader), with some initial involvement of Baba Ramchandra. It was NOT primarily an INC-led movement; the Congress leadership was actually uncomfortable with its radical mass character.
— Cause: Protest against high rents (beyond 50% above the recorded rate), forced labour (begar), and the practice of share-cropping under oppressive terms.
— Outcome: The movement was suppressed by British authorities and did not achieve its primary goals. Madari Pasi was arrested and the movement dissolved.
...
export default modernHistoryPYQData;
