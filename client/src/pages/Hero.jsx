...
function QuotePanel({ customQuote }) {
  ...
  return (
    <div className="mt-4 sm:mt-5 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-4 py-4 sm:py-5">
  ...
  return (
    <section className="relative overflow-hidden rounded-xl sm:rounded-3xl mx-3 sm:mx-6 mt-3 sm:mt-6 shadow-2xl">
      ...
      <div className="relative z-10 px-2 sm:px-4 md:px-6 pt-3 sm:pt-4 md:pt-5 pb-6 sm:pb-7 md:pb-8">
        ...
        {/* Hero title */}
        <h1 className="font-display text-2xl sm:text-3xl md:text-[38px] lg:text-[42px] font-normal text-white leading-[1.2] sm:leading-[1.1] max-w-lg drop-shadow-lg mb-3 sm:mb-4">
          Every day counts.
          <br />
          Every answer matters.
        </h1>
